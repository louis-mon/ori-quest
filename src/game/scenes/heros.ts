...
// Le seul élément commun à toutes les pièces, d'où ce module partagé. Même
// modèle que la vignette de dialogue : celui qu'on voit dans le décor et celui
// qui parle doivent être reconnaissables l'un dans l'autre.
